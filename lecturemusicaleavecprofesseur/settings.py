"""
Django settings for lecturemusicaleavecprofesseur project.
...
ROOT_URLCONF = 'lecturemusicaleavecprofesseur.urls'
...
WSGI_APPLICATION = 'lecturemusicaleavecprofesseur.wsgi.application'
